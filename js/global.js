...
var amandaPalmerMovie = new Trailer('Amanda Palmer', 'xMj_P_6H69g');
var mossMovie = new Trailer('moss', 'o0gH_omVWIg');
var workaholicsMovie = new Trailer('workaholics', 'qMzt3yQFT-Q');
var reggieWattsMovie = new Trailer('Reggie Watts', 'Jm0EdiOpuIQ');
